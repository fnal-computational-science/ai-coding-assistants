...
This assumes you have already run the command to build the code and run the tests in a terminal window.
In many cases you will need several iteration with Copilot to get to the point where you have commands that work as you want them to.
